    ...
    return (
        ...
        <header className='flex flex-row justify-between items-center'>
            <div className="flex flex-col md:flex-row p-5">
                ...
                <button className='inline-flex w-full md:w-auto px-5 py-3 rounded-md mb-3 border-2 btn-per-2'>
                    <img src="/svg/edit.svg" className='w-6 mr-3'/>
                    Edit Links
                </button>
                </Link>
                <Link href="/edit/profile">
                <button className='border-2 inline-flex w-full md:w-auto px-5 py-3 rounded-md mb-3  md:ml-4 btn-per'>
